...
const Nav = () => {
    ...
    return(
        ...
        <div className={height < 70 ? 'flex justify-between items-center px-[30px] md:px-[139px] py-[15px] md:py-[15px] md:pt-[35px] bg-none z-[999] relative top-0':'flex justify-between items-center px-[30px] md:px-[139px] py-[15px] md:py-[15px] bg-white z-[1000] sticky top-0'}>
            <div className='w-fit'>
                <a href="/" className={(location.pathname == '/' || location.pathname == '/home' || location.pathname == '/waiting' || location.pathname == '/waiting') && height < 70 ?'text-[30px] md:text-[44px] font-manrope font-semibold text-white':'text-[30px] md:text-[44px] font-manrope font-semibold text-primary flex gap-2 items-center'}>
            ...
            <div className='hidden md:flex gap-2'>
              <a href="/pricing" className='nav-item btn btn-light'>
                Join
              </a>
          ...
          >
            ...
            <div className='mt-20'>
              <ul className=''>
                ...
                <a href="/" className='nav-item block btn btn-dark mt-5'>
                  <li>Join</li>
                </a>
              </ul>
