                ...
                <div className='flex flex-wrap w-auto justify-between md:gap-32 mt-5'>
                    <div className='mb-2 md:mb-10'>
                        ...
                        <ul className='text-textBlack'>
                            <a href="/about"><li className='mb-3 text-[13px] md:text-[16px]'>About</li></a>
                            <a href="/contact"><li className='mb-3 text-[13px] md:text-[16px]'>Contact</li></a>
                        </ul>
                    </div>
                    <div className='mb-2 md:mb-10'>
                        <p className='text-[14px] md:text-[16px] font-semibold mb-2 md:mb-5 text-deepBlue'>Company</p>
                        <ul className='text-textBlack'>
                            <a href="/"><li className='mb-3 text-[13px] md:text-[16px]'>Home</li></a>
                            <a href="/pricing"><li className='mb-3 text-[13px] md:text-[16px]'>Pricing</li></a>
                        </ul>
                    </div>
                    <div className='mb-2 md:mb-10'>
                        <p className='text-[14px] md:text-[16px] font-semibold mb-2 md:mb-5 text-deepBlue'>Resources</p>
                        <ul className='text-textBlack'>
                            <a href="/features"><li className='mb-3 text-[13px] md:text-[16px]'>Features</li></a>
